...
const Navbar = () => {
  ...
  return (
    <div>
      <div
        className="navbar bg-[linear-gradient(to_right,#94a3b8,#e2e8f0,#94a3b8)] mb-10 md:space-x-5"
        id="navActive"
      >
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 text-slate-900 text-sm lg:text-xl">
            {navLinks}
          </ul>
        </div>
